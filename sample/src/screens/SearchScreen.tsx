...
import {
  EAUTY_BEST_DEALS_OF_THE_WEEK_COLLECTION_ID, ELECTRONIC_BEST_DEALS_OF_THE_WEEK_COLLECTION_ID, ELECTRONIC_POPULAR_PRODUCT_COLLECTION_ID, AUTOMOTIVE_BEST_DEALS_OF_THE_WEEK_COLLECTION_ID
  , SPORTS_BEST_DEALS_OF_THE_WEEK_COLLECTION_ID, AUTOMOTIVE_POPULAR_PRODUCT_COLLECTION_ID, SPORTS_POPULAR_PRODUCT_COLLECTION_ID} from '../constants/Constants'
      ...
      <ImageBackground style={[styles.container, flex, { backgroundColor: colors.whiteColor }]} source={isDarkMode ? '' : BACKGROUND_IMAGE}>
        ...
        <View style={{ paddingHorizontal: spacings.large }}>
          <View style={[positionRelative]}>
            ...
            {showSuggestions && (
              <View style={[positionAbsolute, styles.suggestionBox, { backgroundColor:colors.whiteColor, zIndex:9 }]}>
                ...
                />) : (
                  <View style={[alignJustifyCenter, { width: wp(100), height: hp(79), alignSelf: "center", backgroundColor:colors.whiteColor,zIndex
                  :99999}]}>
                    <View>
         ...
         {!showSuggestions && <View>
           <Text style={[styles.text, { padding: 10, color: colors.blackColor , zIndex:1}]}>{POPULAR}</Text>
